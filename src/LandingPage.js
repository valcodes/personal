    ...
    return (
      <div className="background">
        <div className="main-page">
          ...
          <section className="hero is-light " id="portfolio">
            <div className="hero-body">
          ...
          <section className="hero is-light " id="about">
            <div className="hero-body">
              <div className="container">
                ...
                <div className="tile is-ancestor">
                  <div className="tile is-child is-10 ">
                    <p className="subtitle">
                      ...
                      tech began with receiving a Super Nintendo for my 8th
                      birthday. I moved to USA in my teens and learned English
                      in less than 6 months. I have a passion for code and
                      learning and can't wait to show you what I can do.
                    </p>
                  </div>
          ...
          <section className="hero is-dark " id="contact">
            <div className="hero-body">
              <div className="container">
            ...
            <div className="hero-body">
              <div className="container has-text-centered">
                <a
                  ...
                  href="mailto:vabramova1@gmail.com"
                >
